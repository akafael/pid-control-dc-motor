% Programa para Seguidor de Referecia do tipo Degrau

clear all;
close all;

%% Converte a funcao de transferencia em espaço de estados 
...
%% Acha Polinomio Característico Controlador para K simbolico
...
Ke = acker(A',C',Polos(1:2))';% Matriz de ganho do observador
 ...
 t = 0:0.01:10;           % Tempo da simulacao
